...
public class PollerImplTest {
  ...
  @Mock Consumer<byte[], byte[]> underlying;
  ...
  public void pollTranslates() {
    ...
    assertThat(result.sourcePartition())
        .isEqualTo(
            ImmutableMap.of(
                "topic",
                example(TopicPath.class).toString(),
    ...
    ImmutableListMultimap.Builder<String, byte[]> resultHeadersBuilder =
